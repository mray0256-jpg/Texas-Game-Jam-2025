...
## Gameplay
A Mario-Esque platformer in which a player has been cursed as a frog and placed in a loop! The player must defeat an evil wizard to escape and regain their humanity.
...
## Future Improvements
- Though the game jam is finished and the project will not be revisited, there are many things that could've been improved.
- Cord organization and architecture (improved reuse, optimization, data-driven design)
